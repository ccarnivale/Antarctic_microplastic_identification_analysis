...
print(plastic_lab_count)
print(plastic_lab_filt)

#ggtexttable(plastic_lab_count)

#ggtexttable(plastic_lab_filt)

#Even with the move to the high performance computing server the computations 
#are taking longer than they should. I need to look into algorithm optimization.
#Likely first stop is to 
